...
const QUESTIONS = [
  ...
  'ما أكبر التحديات التي واجهتها في بداية المهنة؟',
  'ما كانت أول مسؤولياتك في هذه المهنة؟',
  'ما الإنجاز الذي تفخر أنك حققته؟',
  'ما هي أعلى مكانة وظيفية حصلت عليها؟',
  'ماذا هي خططك بعد التقاعد من هذه المهنة؟',
]
